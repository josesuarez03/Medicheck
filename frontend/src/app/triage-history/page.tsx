  ...
  return (
    <div className="space-y-6">
      <PageHero
        ...
        description="El historial queda fuera del chat principal para que la conversación tenga más foco visual y las acciones de gestión vivan donde tienen sentido."
        actions={
          <>
