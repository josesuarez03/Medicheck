# Generated by Django 5.1.6 on 2026-03-24 13:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_validated_at', models.DateTimeField(blank=True, null=True)),
                ...
                ('data_validated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='validated_patients', to='users.doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('chatbot', 'Chatbot'), ('doctor', 'Doctor'), ('patient', 'Paciente'), ('admin', 'Administrador')], default='chatbot', max_length=20)),
                ...
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history_entries', to='users.patient')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['resource_type', 'resource_id', 'timestamp'], name='users_audit_resourc_042535_idx'), models.Index(fields=['actor_user', 'timestamp'], name='users_audit_actor_u_819fda_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('doctor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patient_relations', to='users.doctor')),
                ('patient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='doctor_relations', to='users.patient')),
            ],
            options={
